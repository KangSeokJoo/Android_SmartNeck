...
import com.smartneck.fit.Fit.util.Fit_BreakTimeDialog;
import com.smartneck.fit.Fit.util.Fit_Commend;
import com.smartneck.fit.Fit.util.Fit_Constants;
import com.smartneck.fit.Fit.util.Fit_DialogSeatControl;
...
import static com.smartneck.fit.Fit.Main.Fit_MainActivity.protocolType;
import static com.smartneck.fit.Fit.Main.Fit_MainActivity.setAudio;
import static com.smartneck.fit.Fit.Main.Fit_MainActivity.setMessage;
import static com.smartneck.fit.Fit.Main.Fit_MainActivity.tabPos;
import static com.smartneck.fit.Fit.Main.Fit_WeightSettingFragment.currentWeight;
import static com.smartneck.fit.Fit.Main.Fit_WeightSettingFragment.tmpSetup;
...
import static com.smartneck.fit.Fit.util.Fit_Constants.deviceType;
import static com.smartneck.fit.Fit.util.User.Fit_Preset.breakTime;
import static com.smartneck.fit.Fit.util.User.Fit_Preset.isBreakTime;
import static com.smartneck.fit.Fit.util.User.Fit_Preset.strength;
import static com.smartneck.fit.Fit.util.User.Fit_Preset.userHeightSetting;
